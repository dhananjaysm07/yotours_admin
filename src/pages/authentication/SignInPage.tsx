...
const SignIn = () => {
  ...
  useEffect(() => {
    if (isAuthenticated) {
      const from = location.state?.from?.pathname || "/"; // Replace with your default path
      navigate(from);
    }
  ...
  return (
    <>
      {loading ? (
        ...
        <div className="h-screen bg-white border rounded-sm border-stroke shadow-default dark:border-strokedark dark:bg-boxdark">
