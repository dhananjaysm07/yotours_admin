...
export default () => {
  return (
    <Dialog.Root>
      <Dialog.Trigger className="flex items-center justify-center w-32 py-2 mt-4 ml-2 text-white bg-indigo-600 rounded-md shadow-sm">
        Click me
      </Dialog.Trigger>
      <Dialog.Portal>
        <Dialog.Overlay className="fixed inset-0 w-full h-full bg-black opacity-40" />
        <Dialog.Content className="fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] px-4 w-full max-w-lg">
          <div className="px-4 py-6 bg-white rounded-md shadow-lg sm:flex">
